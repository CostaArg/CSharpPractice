...
namespace schoolExercise
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter 1 to print, 2 to enter student, 3 to enter course,");
            Console.WriteLine("4 to enter trainer, 5 to enter assignment, 6 to enter due date: ");
    ...
    class Data
    {
        ...
        public Data()
        {
            ...
            Assignment a3 = new Assignment("Project Library", new DateTime(2020, 02, 01));
            Assignment a4 = new Assignment("Project Lab", new DateTime(2020, 12, 21));
            Assignment a5 = new Assignment("Project School", new DateTime(2020, 06, 14));
